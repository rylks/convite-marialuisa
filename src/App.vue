...
<template>
  <div v-if="step === 1" class="container">
    <h1>Gostaria de saber se eu posso cuidar do seu coração e alma para sempre em todas as minhas futuras vidas 🥰</h1>
    <div class="buttons">
  ...
  <div v-if="step === 2" class="container">
    <h2>Eu sabia que você não iria recusar, odaskokfoasokdwqfsa!</h2>
    <h3>Mandarei mais informações no Disc! Até breve!!! 🥰</h3>
